...
#'
#' @export
dviJointNEW = function(dvi, assignments = NULL, ignoreSex = FALSE, disableMutations = FALSE, 
  ...
  # prep
  assignmentList = lapply(seq_len(nAss), \(i) as.character(assignments[i, ]))

  # TODO: import purrr and mirai
  # TODO: help user with mirai::require_daemons
  res = purrr::map_dbl(assignmentList, in_parallel(
      \(a) dvir:::loglikAssign(pm, am, vics, a, loglik0, logliks.PM, logliks.AM), 
      pm = pm, am = am, vics = vics, loglik0 = loglik0, logliks.PM = logliks.PM, logliks.AM = logliks.AM),
      .progress = progress)
  
  loglik = res#unlist(res, use.names = FALSE)

...
The complete list of these assignments is generated as follows (see also the function `generateMoves()` below).
...
Finally, the code for performing an exhaustive search (i.e., `limit = 0`) is shown below. With the current implementation this computation takes ca 45 minutes.
